...
> **Conduct Reporting Status Notice:**
> A dedicated private conduct-reporting channel has not yet been configured.
>
> External contributor onboarding remains limited until the project owner creates and verifies a private reporting channel.
>
> Do not report ordinary conduct complaints in public GitHub issues, public discussions, or security advisories. Security vulnerability disclosures are strictly separated from Code of Conduct reporting — for security vulnerabilities, follow [SECURITY.md](SECURITY.md).
