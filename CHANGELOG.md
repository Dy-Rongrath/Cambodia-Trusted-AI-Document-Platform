...
- **Developer Certificate of Origin (DCO):** Added official [DCO.md](DCO.md) (v1.1) and established `git commit -s` sign-off policy for contributions.
- **Community Governance & Health:** Established [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md) (Contributor Covenant v2.1), [GOVERNANCE.md](GOVERNANCE.md), [SUPPORT.md](SUPPORT.md), and [docs/open-source-dependency-policy.md](docs/open-source-dependency-policy.md).
...
- **Actionable Security Reporting:** Configured vulnerability disclosure guidelines referencing GitHub Security tab Private Vulnerability Reporting in [SECURITY.md](SECURITY.md).
