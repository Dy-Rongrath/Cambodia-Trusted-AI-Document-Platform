...
- **Documented Security Reporting Workflow:** Documented a private vulnerability-reporting workflow in [SECURITY.md](SECURITY.md). Repository-level Private Vulnerability Reporting still requires owner verification.
